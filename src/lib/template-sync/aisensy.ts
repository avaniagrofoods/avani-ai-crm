...
export class TemplateSyncEngine {
  static async syncAllApprovedTemplates(): Promise<{
    ...
    const approvedInventory = [
      // 1-5: Personal & General Loan Intro
      ...
      // 11-15: Doctor & Medical Professional Loan
      ...
      // 16-20: Home Loan & Property (Mortgage / LAP)
      ...
      // 21-25: Education Loan — Global & Domestic
      ...
      // 26-30: Chartered Accountant (CA) & Professional Loans
      ...
      // 31-34: Multilingual & Customer Support Interactive Templates
